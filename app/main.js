                ...
                <div className="bg-grey-900 h-screen col-span-2">
                    ...
                    <form>
                        ...
                        <div className="relative">
                            ...
                            <input type="date" onChange={changeDate} className="block w-full p-4 pl-10 text-sm text-gray-900  bg-gray-900 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Date" required />

                            <a onClick={getWeather} className="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Analyze Weather</a>
                        </div>
                    </form>
                ...
                <div className="bg-grey-900 h-screen p-4 col-span-3">
                    <div className="p-2  w-full">
                        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
                            ...
                            <span className="title-font font-medium text-white">Lat: {data ? JSON.stringify(data.location.lat) : null}, Long: {data ? JSON.stringify(data.location.lon) : null}</span>
                        </div>
                    </div>
